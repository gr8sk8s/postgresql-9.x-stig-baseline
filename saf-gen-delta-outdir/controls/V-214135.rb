...
escalation and role changes.'
  desc 'check', "Determine all situations where a user must re-authenticate. Check if
...
If the provided SQL does not force re-authentication, this is a finding."
  desc 'fix', "Modify and/or configure PostgreSQL and related applications and tools
