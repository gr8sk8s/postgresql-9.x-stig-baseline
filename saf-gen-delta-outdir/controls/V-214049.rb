...
If audit records exist without the outcome of the event that occurred, this is a finding.'
  desc 'fix', %q(Using pgaudit PostgreSQL can be configured to audit various facets of PostgreSQL. See supplementary content APPENDIX-B for documentation on installing pgaudit. 
...
$ sudo service postgresql-${PGVER?} reload)
  ...
  tag check_id: 'C-15265r360778_chk'
  tag severity: 'medium'
  tag gid: 'V-214049'
  tag rid: 'SV-214049r508027_rule'
  tag stig_id: 'PGS9-00-000200'
  tag gtitle: 'SRG-APP-000099-DB-000043'
  tag fix_id: 'F-15263r360779_fix'
  tag 'documentable'
  tag legacy: ['SV-87495', 'V-72843']
  tag cci: ['CCI-000134']
  tag nist: ['AU-3 e']
end
